...
namespace DeviceControlPanel.Helpers
{    
    public class SDKHelper
    {
    ...
    #endregion
        public void Log(string message, bool toUserControl = false)
        {
            if (toUserControl)
            {
                gRealEventListBox.Items.Add(message);
            }
        }
        ...
        public int sta_ConnectTCP(string ip, string port, string commKey)
        {
            if (ip == "" || port == "" || commKey == "")
            {
                Log("*Name, IP, Port or Commkey cannot be null !");
            ...
            else
            {
                ...
                Log("*Unable to connect the device,ErrorCode=" + idwErrorCode.ToString());
                return idwErrorCode;
            }
        }
        ...
        public int sta_ConnectRS(string deviceid, string port, string baudrate, string commkey)
        {
            ...
            {
                Log("*Device ID, Port, Baudrate, Comm Key cannot be null !");
                return -1;
            }
        ...
        public int sta_ConnectUSB(string deviceid, string commkey)
        {
            if (deviceid == "" || commkey == "")
            {
                Log("*deviceid, commkey cannot be null !");
                return -1;
            }
            ...
            if (bSearch == false)
            {
                Log("*Can not find the virtual serial port that can be used !");
                return -1;
            }
        ...
        public int sta_GetDeviceInfo(out string sFirmver, out string sMac, out string sPlatform, out string sSN, out string sProductTime, out string sDeviceName, out int iFPAlg, out int iFaceAlg, out string sProducter)
        {
            ...
            */
             ...
             */
            //Log("[func GetDeviceFirmwareVersion]Temporarily unsupported");
            ...
            Log("Get the device info successfully");
            iRet = 1;
            return iRet;
        }
        ...
        public int sta_GetCapacityInfo(out int adminCnt, out int userCount, out int fpCnt, out int recordCnt, out int pwdCnt, out int oplogCnt, out int faceCnt)
        {
            ...
            Log("Get the device capacity successfully");
        ...
        public ListBox gRealEventListBox;
        ...
        public int sta_RegRealTime()
        {
            ...
            else
            {
                ...
                if (idwErrorCode != 0)
                {
                    Log("*RegEvent failed,ErrorCode: " + idwErrorCode.ToString());
                }
                else
                {
                    Log("*No data from terminal returns!");
                }
            }
            return ret;
        }
        ...
        void axCZKEM1_OnEnrollFingerEx(string EnrollNumber, int FingerIndex, int ActionResult, int TemplateLength)
        {
            if (ActionResult == 0)
            {
                Log("Enroll finger succeed. UserID=" + EnrollNumber.ToString() + "...FingerIndex=" + FingerIndex.ToString());
            }
            else
            {
                Log("Enroll finger failed. Result=" + ActionResult.ToString());
            }
        ...
        {
            Log("Door opened" + "...EventType=" + EventType.ToString());
        ...
        {
            Log("Alarm triggered" + "...AlarmType=" + AlarmType.ToString() + "...EnrollNumber=" + EnrollNumber.ToString() + "...Verified=" + Verified.ToString());
        ...
        {
            Log("Card event" + "...Cardnumber=" + CardNumber.ToString());
        ...
        {
            //onMessage("message");
            Log("Enroll a　new user" + "...UserID=" + EnrollNumber.ToString());
        ...
        {
            Log("Delete a finger template" + "...UserID=" + EnrollNumber.ToString() + "..FingerIndex=" + FingerIndex.ToString());
        ...
        {
            Log("Press finger score=" + Score.ToString());
        ...
        void axCZKEM1_OnAttTransactionEx(string EnrollNumber, int IsInValid, int AttState, int VerifyMethod, int Year, int Month, int Day, int Hour, int Minute, int Second, int WorkCode)
        {
            ...
            Log("Verify OK.UserID=" + EnrollNumber + " isInvalid=" + IsInValid.ToString() + " state=" + AttState.ToString() + " verifystyle=" + VerifyMethod.ToString() + " time=" + time);
        ...
        {
            string time = Year + "-" + Month + "-" + Day + " " + Hour + ":" + Minute + ":" + Second;
            Log("Verify OK.UserID=" + EnrollNumber.ToString() + " isInvalid=" + IsInValid.ToString() + " state=" + AttState.ToString() + " verifystyle=" + VerifyMethod.ToString() + " time=" + time);
        ...
        void axCZKEM1_OnVerify(int UserID)
        {
            if (UserID != -1)
            {
                Log("User fingerprint verified... UserID=" + UserID.ToString());
            }
            else
            {
                Log("Failed to verify... ");
            }
        ...
        void axCZKEM1_OnWriteCard(int iEnrollNumber, int iActionResult, int iLength)
        {
            if (iActionResult == 0)
            {
                Log("Write Mifare Card OK" + "...EnrollNumber=" + iEnrollNumber.ToString() + "...TmpLength=" + iLength.ToString());
            }
            else
            {
                Log("...Write Failed");
        ...
        {
            Log("RTEvent OnKeyPress Has been Triggered, Key: " + iKey.ToString());
        }
        ...
        void axCZKEM1_OnEnrollFinger(int EnrollNumber, int FingerIndex, int ActionResult, int TemplateLength)
        {
            if (ActionResult == 0)
            {
                Log("Enroll finger succeed. UserID=" + EnrollNumber + "...FingerIndex=" + FingerIndex.ToString());
            }
            else
            {
                Log("Enroll finger failed. Result=" + ActionResult.ToString());
 ...
 #region UserMng
        ...
        public int sta_DeleteEnrollData(ComboBox cbUseID, ComboBox cbBackupDE)
        {
            if (GetConnectState() == false)
            {
                Log("*Please connect first!");
            ...
            if (axCZKEM1.SSR_DeleteEnrollData(iMachineNumber, sUserID, iBackupNumber))
            {
                ...
                Log("SSR_DeleteEnrollData,UserID=" + sUserID + " BackupNumber=" + iBackupNumber.ToString());
            }
            else
            {
                axCZKEM1.GetLastError(ref idwErrorCode);
                if (idwErrorCode == 0 && iBackupNumber == 11)
                    ...
                    Log("*Operation failed,ErrorCode=" + idwErrorCode.ToString());
            }

            return 1;
        }

        public int sta_DelUserTmp(ComboBox cbUseID, ComboBox cbFingerIndex)
        {
            if (GetConnectState() == false)
            {
                Log("*Please connect first!");
            ...
            {
                axCZKEM1.RefreshData(iMachineNumber);//the data in the device should be refreshed
                Log("SSR_DelUserTmpExt,UserID:" + sUserID + " FingerIndex:" + iFingerIndex.ToString());
            }
            else
            {
                axCZKEM1.GetLastError(ref idwErrorCode);
        ...
        public int sta_OnlineEnroll(TextBox txtUserID, ComboBox cbFingerIndex, ComboBox cbFlag)
        {
            if (GetConnectState() == false)
            {
                Log("*Please connect first!");
            ...
            {
                Log("*User ID error! The max length is " + iPIN2Width.ToString());
                return -1022;
            }
            ...
            if (iIsABCPinEnable == 0 || iT9FunOn == 0)
            {
                ...
                {
                    Log("*User ID error! The first letter can not be as 0");
                    return -1022;
                }
                ...
                foreach (char tempchar in txtUserID.Text.ToCharArray())
                {
                    ...
                    {
                        Log("*User ID error! User ID only support digital");
                        return -1022;
                    }
                }
            }
            ...
            {
                Log("Start to Enroll a new User,UserID=" + sUserID + " FingerID=" + iFingerIndex.ToString() + " Flag=" + iFlag.ToString());
                if (axCZKEM1.StartIdentify())
                {
                    Log("Enroll a new User,UserID" + sUserID);
                }
        ...
        public int sta_SetUserInfo(TextBox txtUserID, TextBox txtName, ComboBox cbPrivilege, TextBox txtCardnumber, TextBox txtPassword)
        {
            if (GetConnectState() == false)
            {
                Log("*Please connect first!");
            ...
            if (iPrivilege == 5)
            {
                Log("*User Defined Role is Error! Please Register again!");
                return -1023;
            }
            ...
            if(iPrivilege == 4)
            {
                ...
                if (bFlag == false)
                {
                    Log("*User Defined Role is unable!");
                    return -1023;
                }
            }
             */
            //Log("[func IsUserDefRoleEnable]Temporarily unsupported");
            ...
            */
            ...
            {
                Log("Set user information successfully");
            }
            else
            {
                axCZKEM1.GetLastError(ref idwErrorCode);
        ...
        public int sta_GetUserInfo(TextBox txtUserID, TextBox txtName, ComboBox cbPrivilege, TextBox txtCardnumber, TextBox txtPassword)
        {
            if (GetConnectState() == false)
            {
                Log("*Please connect first!");
            ...
            {
                Log("*Please input user id first!");
                return -1023;
            }
            ...
            if (axCZKEM1.SSR_GetUserInfo(iMachineNumber,txtUserID.Text.Trim(), out strName, out strPassword,out iPrivilege, out bEnabled))//upload the user's information(card number included)
            {
                ...
                Log("Get user information successfully");
            }
            else
            {
                axCZKEM1.GetLastError(ref idwErrorCode);
        ...
        public int sta_GetHIDEventCardNum(ListBox lblOutputInfo)
        {
            ...
            {
                Log("GetHIDEventCardNumAsStr! HIDCardNum=" + strHIDEventCardNum);
            }
            else
            {
                axCZKEM1.GetLastError(ref idwErrorCode);
        ...
        public int sta_SetUserValidDate(ComboBox cbExpires, TextBox txtID2, DateTimePicker dtStartDate, DateTimePicker dtEndDate, TextBox txtCount)
        {
            if (GetConnectState() == false)
            {
                Log("*Please connect first!");
            ...
            {
                Log("*Please input user ID or Exprires first!");
                return -1023;
            }
            ...
            switch (expires)
            {
                ...
                case 1:
                    ...
                    {
                        Log("*Please input StartDate or EndDate first!");
                        return -1022;
                    }
                ...
                default:
                    Log("*Expires Error,please input again!");
                    return -1022;
            ...
            {
                axCZKEM1.RefreshData(iMachineNumber);//the data in the device should be refreshed
                Log("Successfully set the ValidDate!");
            }
            else
            {
                axCZKEM1.GetLastError(ref idwErrorCode);
            ...
            //Log("[func SetUserValidDate]Temporarily unsupported");

            return 1;
        }

        public int sta_GetUserValidDate(ComboBox cbExpires, TextBox txtID2, DateTimePicker dtStartDate, DateTimePicker dtEndDate, TextBox txtCount)
        {
            if (GetConnectState() == false)
            {
                Log("*Please connect first!");
            ...
            if (axCZKEM1.GetUserValidDate(iMachineNumber, sUserID, out iExpires, out validcount, out sStartDate, out sEndDate))
            {
                ...
                Log("Get user valid date successfully");
            }
            else
            {
                axCZKEM1.GetLastError(ref idwErrorCode);
                ...
                if (idwErrorCode == -4996)          //User is exsit but not set ValideDate
                {
                    ...
                    txtCount.Text = "0";
                    Log("*Operation failed,This User Don't Set ValideDate Or LimitCounts.");
                }
                else if (idwErrorCode == -4993)     //User is not exist
                {
                    ...
                    dtEndDate.Text = DateTime.Now.ToShortDateString().ToString();
                    txtCount.Text = "0";
                    Log("*Operation failed,This User is not exist.");
                }
                else
                {
                    txtCount.Text = " ";
            ...
            //Log("[func GetUserValidDate]Temporarily unsupported");

            return 1;
        }

        public int sta_GetUserVerifyStyle( ComboBox cbUserID7, ComboBox cbVerifyStyle )
        {
            if (GetConnectState() == false)
            {
                Log("*Please connect first!");
            ...
            if (axCZKEM1.GetUserInfoEx(GetMachineNumber(), Convert.ToInt32(sUserID), out iVerifyStyle, out bReserved))
            {
                ...
                Log("Get user verify style successfully");
            }
            else
            {
                axCZKEM1.GetLastError(ref idwErrorCode);
            ...
            */
            ...
            //Log("[func GetUserVerifyStyle]Temporarily unsupported");
            return 1;
        }

        public int sta_SetUserVerifyStyle(ComboBox cbUserID7, ComboBox cbVerifyStyle)
        {
            if (GetConnectState() == false)
            {
                Log("*Please connect first!");
            ...
            {
                Log("*Please input the UserID or VerifyStyle!");
                return -1023;
            }
            int idwErrorCode = 0;
            ...
            {
                Log("Set verify style successfully!");
            }
            else
            {
                axCZKEM1.GetLastError(ref idwErrorCode);
            ...
            */
            //Log("[func SetUserVerifyStyle]Temporarily unsupported");
        ...
        #region UesrFP
        public int sta_GetAllUserFPInfo(ProgressBar prgSta, ListView lvUserInfo)
        {
            if (GetConnectState() == false)
            {
                Log("*Please connect first!");
            ...
            prgSta.Value = 100;
            Log("Download user count : " + num.ToString() + " ,  fingerprint count : " + iFpCount.ToString());
            axCZKEM1.EnableDevice(iMachineNumber, true);
            return 1;
        }
        ...
        public int sta_SetAllUserFPInfo(ProgressBar prgSta, ListView lvUserInfo)
        {
            ...
            {
                Log("*There is no data can upload!");
                return -1023;
            }
            ...
            for (int i = 0; i < lvUserInfo.Items.Count; i++)
            {
                ...
                {
                    axCZKEM1.GetLastError(ref idwErrorCode);
                    Log("*Upload user " + sEnrollNumber + " error,ErrorCode=!" + idwErrorCode.ToString());
                    //axCZKEM1.EnableDevice(iMachineNumber, true);
                    //return -1022;
                }
        ...
        public int sta_batch_SetAllUserFPInfo(ProgressBar prgSta, ListView lvUserInfo)
        {
            ...
            axCZKEM1.RefreshData(iMachineNumber);//the data in the device should be refreshed
            axCZKEM1.EnableDevice(iMachineNumber, true);
            Log("Upload user successfully in batch");
            return 1;
        }
        ...
        public int sta_GetAllUserFaceInfo(ProgressBar prgSta, ListView lvUserInfo)
        {
            ...
            prgSta.Value = 100;
            Log("Download user  face count : " + num.ToString());
            axCZKEM1.EnableDevice(iMachineNumber, true);
            return 1;
        }
        ...
        public int sta_DownloadAllUserPhoto(TextBox txtAllPhotoPath)
        {
            if (GetConnectState() == false)
            {
                Log("*Please connect first!");
            ...
            {
                ret = 1;
                Log("Get All User Photo From the Device!");
            }
            else
            {
                axCZKEM1.GetLastError(ref idwErrorCode);
                ...
                if (idwErrorCode != 0)
                {
                    Log("*Download all user photo failed,ErrorCode: " + idwErrorCode.ToString());
                }
                else
                {
                    Log("No data from terminal returns!");
            ...
            //Log("[func GetAllUserPhoto]Temporarily unsupported");
        ...
        public int sta_UploadAllUserPhoto(TextBox txtAllPhotoPath)
        {
            if (GetConnectState() == false)
            {
                Log("*Please connect first!");
            ...
            //if (num <= 0)
            //{
            //    Log("*There is no picture can update.");
            //    return -1023;
            //}
            ...
            foreach (FileInfo NextFile in Directory.GetFiles())
            {
                ...
                if (NextFile.Name.IndexOf(".jpg") > 0)
                {
                    if (axCZKEM1.UploadUserPhoto(GetMachineNumber(), fileName))
                    {
                        ...
                        ret = 1;
                        Log("Upload user photo to device successfully, file name : " + NextFile.Name);
                    }
                    else
                    {
                        axCZKEM1.GetLastError(ref idwErrorCode);
                        ...
                        if (idwErrorCode != 0)
                        {
                            Log("*Upload user photo failed,ErrorCode: " + idwErrorCode.ToString());
                        }
                        else
                        {
                            Log("No data from terminal returns!");
                ...
                else
                {
                    ...
                    {
                        Log("*Data format error,file name : " + NextFile.Name);
                    }
                }
            }
            
            //Log("[func UploadUserPhoto]Temporarily unsupported");
            axCZKEM1.EnableDevice(GetMachineNumber(), true);//enable the device
        ...
        public int sta_uploadOneUserPhoto(string fullName)
        {
            ...
            if (axCZKEM1.UploadUserPhoto(GetMachineNumber(), fullName))
            {
                axCZKEM1.RefreshData(GetMachineNumber());//the data in the device should be refreshed
                ret = 1;
                Log("Upload User Photo To the Device succeed!");
            }
            else
            {
                axCZKEM1.GetLastError(ref idwErrorCode);
        ...
        public int sta_downloadOneUserPhoto(string userID, string path)
        {
            ...
            {
                ret = 1;
                Log("Download User Photo from the Device succeed!");
            }
            else
            {
                axCZKEM1.GetLastError(ref idwErrorCode);
                ...
                if (idwErrorCode != 0)
                {
                    Log("Download user photo failed,ErrorCode: " + idwErrorCode.ToString());
                }
                else
                {
                    Log("No data from terminal returns!");
            ...
            //Log("[func DownloadUserPhoto]Temporarily unsupported");
            axCZKEM1.EnableDevice(GetMachineNumber(), true);//enable the device
        ...
        public int sta_DeleteOneUserPhoto(string userID)
        {
            ...
            if (axCZKEM1.DeleteUserPhoto(GetMachineNumber(), photoName))
            {
                axCZKEM1.RefreshData(GetMachineNumber());//the data in the device should be refreshed
                ret = 1;
                Log("Delate User Photo in the Device succeed!");
            }
            else
            {
                axCZKEM1.GetLastError(ref idwErrorCode);
                ...
                if (idwErrorCode != 0)
                {
                    Log("*Delete user photo failed,ErrorCode: " + idwErrorCode.ToString());
                }
                else
                {
                    Log("No data from terminal returns!");
            ...
            //Log("[func DeleteUserPhoto]Temporarily unsupported");
            axCZKEM1.EnableDevice(GetMachineNumber(), true);//enable the device
        ...
        public int sta_GetSMS(TextBox txtSMSID, ComboBox cbTag, TextBox txtValidMin, DateTimePicker dtStartTime, TextBox txtContent)
        {
            if (GetConnectState() == false)
            {
                Log("*Please connect first!");
        ...
        public int sta_SetSMS(TextBox txtSMSID, ComboBox cbTag, TextBox txtValidMin, DateTimePicker dtStartTime, TextBox txtContent)
        {
            if (GetConnectState() == false)
            {
                Log("*Please connect first!");
            ...
            if (axCZKEM1.SetSMS(iMachineNumber, iSMSID, iTag, iValidMins, sStartTime, sContent))
            {
                ...
                Log("Successfully set SMS! SMSType=" + iTag.ToString());
            }
            else
            {
                axCZKEM1.GetLastError(ref idwErrorCode);
        ...
        public int sta_SetUserSMS(TextBox txtSMSID, ComboBox cbUserID)
        {
            if (GetConnectState() == false)
            {
                Log("*Please connect first!");
            ...
            if (iTag != 254)
            {
                Log("*The SMS does not Personal SMS,please set it as Personal SMS first!!");
                axCZKEM1.EnableDevice(iMachineNumber, true);
                return -1022;
            }
        ...
        public int sta_DelSMS(TextBox txtSMSID)
        {
            if (GetConnectState() == false)
            {
                Log("*Please connect first!");
        ...
        public int sta_DelUserSMS(TextBox txtSMSID, ComboBox cbUserID)
        {
            if (GetConnectState() == false)
            {
                Log("*Please connect first!");
            ...
            {
                axCZKEM1.RefreshData(iMachineNumber);//After you have set user short message,you should refresh the data of the device
                Log("Successfully delete user SMS! ");
            }
            else
            {
                axCZKEM1.GetLastError(ref idwErrorCode);
        ...
        public int sta_ClearSMS(ListBox lblOutputInfo)
        {
            ...
            {
                axCZKEM1.RefreshData(iMachineNumber);//After you have set user short message,you should refresh the data of the device
                Log("Successfully clear all the SMS! ");
            }
            else
            {
                axCZKEM1.GetLastError(ref idwErrorCode);
        ...
        public int sta_ClearUserSMS(ListBox lblOutputInfo)
        {
            ...
            {
                axCZKEM1.RefreshData(iMachineNumber);//After you have set user short message,you should refresh the data of the device
                Log("Successfully clear all the user SMS! ");
            }
            else
            {
                axCZKEM1.GetLastError(ref idwErrorCode);
        ...
        #region Workcode
        public int sta_GetWorkCode(TextBox txtWorkcodeID, TextBox txtWorkcodeName)
        {
            if (GetConnectState() == false)
            {
                Log("*Please connect first!");
        ...
        public int sta_SetWorkCode(TextBox txtWorkcodeID, TextBox txtWorkcodeName)
        {
            if (GetConnectState() == false)
            {
                Log("*Please connect first!");
            ...
            */
            //Log("[func SSR_GetWorkCodeIDByName]Temporarily unsupported");
            axCZKEM1.EnableDevice(iMachineNumber, false);
            if (axCZKEM1.SSR_SetWorkCode(iWorkcodeID, sName))
            {
                Log("Successfully set workcode");
        ...
        public int sta_DelWorkCode(TextBox txtWorkcodeID)
        {
            if (GetConnectState() == false)
            {
                Log("*Please connect first!");
            ...
            {
                Log("Successfully delete workcode");
            }
            else
            {
                axCZKEM1.GetLastError(ref idwErrorCode);
        ...
        public int sta_ClearWorkCode(ListBox lblOutputInfo)
        {
            ...
            {
                Log("Successfully clear all workcode");
            }
            else
            {
                axCZKEM1.GetLastError(ref idwErrorCode);
        ...
        public int sta_GetUserRole(ComboBox cbUserRole, int[] iAppState, int[] iFunUserMng, int[] iFunAccess, int[] iFunICCard, int[] iFunComm, int[] iFunSystem, int[] iFunPersonalize, int[] iFunDataMng, int[] iFunUSBMng, int[] iFunAttSearch, int[] iFunPrint, int[] iFunSMS, int[] iFunWorkCode, int[] iFunAutoTest, int[] iFunSysInfo)
        {
            if (GetConnectState() == false)
            {
                Log("*Please connect first!");
...
/*
            ...
            if (axCZKEM1.GetAppOfRole(iMachineNumber, iUserRole, out sAppName))
            {
                if (axCZKEM1.GetFunOfRole(iMachineNumber, iUserRole, out sFunName))
                {
                    ...
                    axCZKEM1.RefreshData(iMachineNumber);//After you have set user short message,you should refresh the data of the device
                    Log("Get user role successfully! ");
                }
                else
                {
                    axCZKEM1.GetLastError(ref idwErrorCode);
                    Log("*Get sub menu failed,ErrorCode=" + idwErrorCode.ToString());
            ...
            {
                axCZKEM1.GetLastError(ref idwErrorCode);
                Log("*Get top menu failed,ErrorCode=" + idwErrorCode.ToString());
            }
            */
            Log("[func GetAppOfRole]Temporarily unsupported");
            //axCZKEM1.EnableDevice(iMachineNumber, true);

            return 1;
        }

        public int sta_SetUserRole(ComboBox cbUserRole, int[] iAppState, int[] iFunUserMng, int[] iFunAccess, int[] iFunICCard, int[] iFunComm, int[] iFunSystem, int[] iFunPersonalize, int[] iFunDataMng, int[] iFunUSBMng, int[] iFunAttSearch, int[] iFunPrint, int[] iFunSMS, int[] iFunWorkCode, int[] iFunAutoTest, int[] iFunSysInfo)
        {
            if (GetConnectState() == false)
            {
                Log("*Please connect first!");
...
*/
            ...
            for (int i = 0; i < iFunUserMng.Length; i++)
            {
                if (iFunUserMng[i] == 1)
                {
                    ...
                    {
                        axCZKEM1.GetLastError(ref idwErrorCode);
                        Log("*Set User Mgt menu failed,sub menu index=" + i.ToString() + ",ErrorCode=" + idwErrorCode.ToString());
                        dd ++;
                    }
                }
                else
            ...
            for (int i = 0; i < iFunAccess.Length; i++)
            {
                if (iFunAccess[i] == 1)
                {
                    ...
                    {
                        axCZKEM1.GetLastError(ref idwErrorCode);
                        Log("*Set Access Control menu failed,sub menu index=" + i.ToString() + ",ErrorCode=" + idwErrorCode.ToString());
                        dd ++;
                    }
                }
                else
            ...
            for (int i = 0; i < iFunICCard.Length; i++)
            {
                if (iFunICCard[i] == 1)
                {
                    ...
                    {
                        axCZKEM1.GetLastError(ref idwErrorCode);
                        Log("*Set IC Card menu failed,sub menu index=" + i.ToString() + ",ErrorCode=" + idwErrorCode.ToString());
                        dd ++;
                    }
                }
                else
            ...
            for (int i = 0; i < iFunComm.Length; i++)
            {
                if (iFunComm[i] == 1)
                {
                    ...
                    {
                        axCZKEM1.GetLastError(ref idwErrorCode);
                        Log("*Set Comm menu failed,sub menu index=" + i.ToString() + ",ErrorCode=" + idwErrorCode.ToString());
                        dd ++;
                    }
                }
                else
            ...
            for (int i = 0; i < iFunSystem.Length; i++)
            {
                if (iFunSystem[i] == 1)
                {
                    ...
                    {
                        axCZKEM1.GetLastError(ref idwErrorCode);
                        Log("*Set System menu failed,sub menu index=" + i.ToString() + ",ErrorCode=" + idwErrorCode.ToString());
                        dd ++;
                    }
                }
                else
            ...
            for (int i = 0; i < iFunPersonalize.Length; i++)
            {
                if (iFunPersonalize[i] == 1)
                {
                    ...
                    {
                        axCZKEM1.GetLastError(ref idwErrorCode);
                        Log("*Set Personalize menu failed,sub menu index=" + i.ToString() + ",ErrorCode=" + idwErrorCode.ToString());
                        dd++;
                    }
                }
                else
            ...
            for (int i = 0; i < iFunDataMng.Length; i++)
            {
                if (iFunDataMng[i] == 1)
                {
                    ...
                    {
                        axCZKEM1.GetLastError(ref idwErrorCode);
                        Log("*Set Data Mgt menu failed,sub menu index=" + i.ToString() + ",ErrorCode=" + idwErrorCode.ToString());
                        dd++;
                    }
                }
                else
            ...
            for (int i = 0; i < iFunUSBMng.Length; i++)
            {
                if (iFunUSBMng[i] == 1)
                {
                    ...
                    {
                        axCZKEM1.GetLastError(ref idwErrorCode);
                        Log("*Set USB Manager menu failed,sub menu index=" + i.ToString() + ",ErrorCode=" + idwErrorCode.ToString());
                        dd++;
                    }
                }
                else
                {
                    ...
                    {
                        axCZKEM1.GetLastError(ref idwErrorCode);
                        Log("*Set USB Manager menu failed,menu index=" + i.ToString() + ",ErrorCode=" + idwErrorCode.ToString());
                        dd++;
                    }
                }
            }
            ...
            for (int i = 0; i < iFunAttSearch.Length; i++)
            {
                if (iFunAttSearch[i] == 1)
                {
                    ...
                    {
                        axCZKEM1.GetLastError(ref idwErrorCode);
                        Log("*Set Attendance menu failed,sub menu index=" + i.ToString() + ",ErrorCode=" + idwErrorCode.ToString());
                        dd++;
                    }
                }
                else
            ...
            for (int i = 0; i < iFunPrint.Length; i++)
            {
                if (iFunPrint[i] == 1)
                {
                    ...
                    {
                        axCZKEM1.GetLastError(ref idwErrorCode);
                        Log("*Set Print menu failed,sub menu index=" + i.ToString() + ",ErrorCode=" + idwErrorCode.ToString());
                        dd++;
                    }
                }
                else
            ...
            for (int i = 0; i < iFunSMS.Length; i++)
            {
                if (iFunSMS[i] == 1)
                {
                    ...
                    {
                        axCZKEM1.GetLastError(ref idwErrorCode);
                        Log("*Set Short Message menu failed,sub menu index=" + i.ToString() + ",ErrorCode=" + idwErrorCode.ToString());
                        dd ++;
                    }
                }
                else
            ...
            for (int i = 0; i < iFunWorkCode.Length; i++)
            {
                if (iFunWorkCode[i] == 1)
                {
                    ...
                    {
                        axCZKEM1.GetLastError(ref idwErrorCode);
                        Log("*Set Work Code menu failed,sub menu index=" + i.ToString() + ",ErrorCode=" + idwErrorCode.ToString());
                        dd++;
                    }
                }
                else
            ...
            for (int i = 0; i < iFunAutoTest.Length; i++)
            {
                if (iFunAutoTest[i] == 1)
                {
                    ...
                    {
                        axCZKEM1.GetLastError(ref idwErrorCode);
                        Log("*Set Auto Test menu failed,sub menu index=" + i.ToString() + ",ErrorCode=" + idwErrorCode.ToString());
                        dd++;
                    }
                }
                else
            ...
            for (int i = 0; i < iFunSysInfo.Length; i++)
            {
                if (iFunSysInfo[i] == 1)
                {
                    ...
                    {
                        axCZKEM1.GetLastError(ref idwErrorCode);
                        Log("*Set System Info menu failed,sub menu index=" + i.ToString() + ",ErrorCode=" + idwErrorCode.ToString());
                        dd++;
                    }
                }
                else
            ...
            if (dd == 0)
            {
                Log("Set User Role successfully~");
            }
            */
            Log("[func SetPermOfAppFun]Temporarily unsupported");
            return 1;
        }
        #endregion
        #region UserBio
        ...
        */
        ...
        public int sta_GetAllBellData(DataTable dt_allBell)
        {
            ...
            else
            {
                ...
                if (idwErrorCode != 0)
                {
                    Log("*Read all bell schedual data failed,ErrorCode: " + idwErrorCode.ToString());
                }
                else
                {
                    Log("No data from terminal returns!");
        ...
        public int sta_setBellInfo(int weekday, int index, int Enable, int Hour, int min, int voice, int bellway, int inerbelldelay, int extbelldelay)
        {
            ...
            {
                Log("*The Device does not support external bell!");
                return -1022;
            }
            ...
            if (axCZKEM1.SetBellSchDataEx(GetMachineNumber(), weekday, index, Enable, Hour, min, voice, bellway, inerbelldelay, extbelldelay))
            {
                ...
                ret = 1;
                Log("Set Bell Schedule successfully!");
            }
            else
            {
                axCZKEM1.GetLastError(ref idwErrorCode);
                ...
                if (idwErrorCode != 0)
                {
                    Log("*Set bell info failed,ErrorCode: " + idwErrorCode.ToString());
                }
                else
                {
                    Log("No data from terminal returns!");
        ...
        public int sta_getAllShortkeyFunctionName(ComboBox cb_stKey, ComboBox cb_function)
        {
            if (GetConnectState() == false)
            {
                Log("*Please connect first!");
            ...
            else
            {
                ...
                if (idwErrorCode != 0)
                {
                    Log("*Read all ShortkeyName FunctionName data failed,ErrorCode: " + idwErrorCode.ToString());
                }
                else
                {
                    Log("No data from terminal returns!");
        ...
        public int sta_getShortkeyByID(int ShortKeyID, ref string ShortKeyName, ref string FunctionName, ref int ShortKeyFun, ref int stateCode, ref string stateName, ref string description, ref int intAutoChange, ref string strAutoChangeTime)
        {
            ...
            {
                Log("Get shortkey successfully. Name:" + ShortKeyName + ",FunctionName:" + FunctionName);
            }
            else
            {
                axCZKEM1.GetLastError(ref idwErrorCode);
                ...
                if (idwErrorCode != 0)
                {
                    Log("*GetShortkeyByID failed,ErrorCode: " + idwErrorCode.ToString());
                }
                else
                {
                    ret = -1;
        ...
        public int sta_setShortkey(int ShortKeyID, string ShortKeyName, string FunctionName, int ShortKeyFun, int stateCode, string stateName, string description,  int intAutoChange, string strAutoChangeTime)
        {
            ...
            {
                Log("Set shortkey successfully. Name:" + ShortKeyName + ",FunctionName:" + FunctionName);
            }
            else
            {
                axCZKEM1.GetLastError(ref idwErrorCode);
                ...
                if (idwErrorCode != 0)
                {
                    Log("*SetShortkey failed,ErrorCode: " + idwErrorCode.ToString());
                }
                else
                {
                    Log("No data from terminal returns!");
        ...
        public int sta_uploadAdvertisePicture(string pictureFile,string pictureName)
        {
            ...
            {
                ret = 1;
                Log("Update a advertise picture!");
            }
            else
            {
                axCZKEM1.GetLastError(ref idwErrorCode);
                ...
                if (idwErrorCode != 0)
                {
                    Log("*Upload advertise picture failed,ErrorCode: " + idwErrorCode.ToString());
                }
                else
                {
                    Log("No data from terminal returns!");
        ...
        public int sta_uploadWallpaper(string pictureFile, string pictureName)
        {
            ...
            else
            {
                ...
                if (idwErrorCode != 0)
                {
                    Log("*Upload wallpaper failed,ErrorCode: " + idwErrorCode.ToString());
                }
                else
                {
                    Log("No data from terminal returns!");
        ...
        public int sta_readAttLog(DataTable dt_log)
        {
            ...
            else
            {
                ...
                if (idwErrorCode != 0)
                {
                    Log("*Read attlog failed,ErrorCode: " + idwErrorCode.ToString());
                }
                else
                {
                    Log("No data from terminal returns!");
        ...
        public int sta_readLogByPeriod(DataTable dt_logPeriod, string fromTime, string toTime)
        {
            ...
            else
            {
                ...
                if (idwErrorCode != 0)
                {
                    Log("*Read attlog by period failed,ErrorCode: " + idwErrorCode.ToString());
                }
                else
                {
                    Log("No data from terminal returns!");
            ...
            //Log("[func ReadTimeGLogData]Temporarily unsupported");
            axCZKEM1.EnableDevice(GetMachineNumber(), true);//enable the device
        ...
        public int sta_DeleteAttLog(ListBox lblOutputInfo)
        {
            ...
            else
            {
                ...
                if (idwErrorCode != 0)
                {
                    Log("*Delete attlog, ErrorCode: " + idwErrorCode.ToString());
                }
                else
                {
                    Log("No data from terminal returns!");
        ...
        public int sta_DeleteAttLogByPeriod(string fromTime, string toTime)
        {
            ...
            else
            {
                ...
                if (idwErrorCode != 0)
                {
                    Log("*Delete attlog by period failed,ErrorCode: " + idwErrorCode.ToString());
                }
                else
                {
                    Log("No data from terminal returns!");
            ...
            //Log("[func DeleteAttlogBetweenTheDate]Temporarily unsupported");
            axCZKEM1.EnableDevice(GetMachineNumber(), true);//enable the device
        ...
        public int sta_DelOldAttLogFromTime(string fromTime)
        {
            ...
            else
            {
                ...
                if (idwErrorCode != 0)
                {
                    Log("*Delete old attlog from time failed,ErrorCode: " + idwErrorCode.ToString());
                }
                else
                {
                    Log("No data from terminal returns!");
            ...
            //Log("[func DeleteAttlogByTime]Temporarily unsupported");
            axCZKEM1.EnableDevice(GetMachineNumber(), true);//enable the device
        ...
        public int sta_ReadNewAttLog(DataTable dt_logNew)
        {
            ...
            //Log("[func ReadNewGLogData]Temporarily unsupported");
            axCZKEM1.EnableDevice(GetMachineNumber(), true);//enable the device
        ...
        //        if (idwErrorCode != 0)
        //        {
        //            Log("*Get photo name failed,ErrorCode: " + idwErrorCode.ToString());
        //        }
        //        else
        //        {
        //            Log("No data from terminal returns!");
        ...
        //                    if (idwErrorCode != 0)
        //                    {
        //                        Log("*Get photo failed,ErrorCode: " + idwErrorCode.ToString());
        //                    }
        //                    else
        //                    {
        //                        Log("No data from terminal returns!");
        ...
        //            }
        //        }
        //        Log("GetAllAttPhotoByTimePeriod succeed.");
        //        ret = 1;
        //    }
        ...
        //            }
        //        }
        //        Log("Get All PASS photo succeed.");
        //        ret = 1;
        //    }
        ...
        //            }
        //        }
        //        Log("GetPassPhotoByTimePeriod succeed.");
        //        ret = 1;
        //    }
        ...
        //            }
        //        }
        //        Log("GetBadPhotoByTimePeriod succeed.");
        //        ret = 1;
        //    }
        ...
        //    {
        //        Log("Clear capture picture OK");
        //    }
        //    else
        //    {
        //        int errorcode = -1;
        //        axCZKEM1.GetLastError(ref errorcode);
        //        Log("Clear capture picture Failed" + errorcode.ToString());
        //    }
        ...
        public int sta_GetOplog(DataTable dt_Oplog)
        {
            ...
            else
            {
                ...
                if (idwErrorCode != 0)
                {
                    Log("*Get OPLOG failed,ErrorCode: " + idwErrorCode.ToString());
                }
                else
                {
                    Log("No data from terminal returns!");
        ...
        public int sta_ClearOplog(ListBox lblOutputInfo)
        {
            ...
            {
                axCZKEM1.RefreshData(GetMachineNumber());//the data in the device should be refreshed
                Log("All operation logs have been cleared from teiminal!");
                ret = 1;
            }
            else
            {
                ...
                if (idwErrorCode != 0)
                {
                    Log("ClearOplog failed,ErrorCode=" + idwErrorCode.ToString());
                }
                else
                {
                    Log("No data from terminal returns!");
        ...
        public int sta_ClearAdmin(ListBox lblOutputInfo)
        {
            ...
            {
                axCZKEM1.RefreshData(GetMachineNumber());//the data in the device should be refreshed
                Log("All administrator have been cleared from teiminal!");
                ret = 1;
            }
            else
            {
                ...
                if (idwErrorCode != 0)
                {
                    Log("*ClearAdmin failed,ErrorCode=" + idwErrorCode.ToString());
                }
                else
                {
                    Log("No data from terminal returns!");
        ...
        public int sta_ClearAllLogs(ListBox lblOutputInfo)
        {
            ...
            {
                axCZKEM1.RefreshData(GetMachineNumber());//the data in the device should be refreshed
                Log("All AttLogs have been cleared from teiminal!");
                ret = 1;
            }
            else
            {
                ...
                if (idwErrorCode != 0)
                {
                    Log("*ClearAllLogs failed,ErrorCode=" + idwErrorCode.ToString());
                }
                else
                {
                    Log("No data from terminal returns!");
        ...
        public int sta_ClearAllFps(ListBox lblOutputInfo)
        {
            ...
            {
                axCZKEM1.RefreshData(GetMachineNumber());//the data in the device should be refreshed
                Log("All fp templates have been cleared from teiminal!");
                ret = 1;
            }
            else
            {
                ...
                if (idwErrorCode != 0)
                {
                    Log("*ClearAllFps failed,ErrorCode=" + idwErrorCode.ToString());
                }
                else
                {
                    Log("No data from terminal returns!");
        ...
        public int sta_ClearAllUsers(ListBox lblOutputInfo)
        {
            ...
            {
                axCZKEM1.RefreshData(GetMachineNumber());//the data in the device should be refreshed
                Log("All users have been cleared from teiminal!");
                ret = 1;
            }
            else
            {
                ...
                if (idwErrorCode != 0)
                {
                    Log("*ClearAllUsers failed,ErrorCode=" + idwErrorCode.ToString());
                }
                else
                {
                    Log("No data from terminal returns!");
        ...
        public int sta_ClearAllData(ListBox lblOutputInfo)
        {
            ...
            {
                axCZKEM1.RefreshData(GetMachineNumber());//the data in the device should be refreshed
                Log("All Data have been cleared from teiminal!");
                ret = 1;
            }
            else
            {
                ...
                if (idwErrorCode != 0)
                {
                    Log("*ClearAllData failed,ErrorCode=" + idwErrorCode.ToString());
                }
                else
                {
                    Log("No data from terminal returns!");
        ...
        #region TimeZone
        public int sta_GetTZInfo(TextBox txtTZIndex, DateTimePicker dtSUNs, DateTimePicker dtMONs, DateTimePicker dtTUEs, DateTimePicker dtWENs, DateTimePicker dtTHUs, DateTimePicker dtFRIs, DateTimePicker dtSATs, DateTimePicker dtSUNe, DateTimePicker dtMONe, DateTimePicker dtTUEe, DateTimePicker dtWENe, DateTimePicker dtTHUe, DateTimePicker dtFRIe, DateTimePicker dtSATe)
        {
            if (GetConnectState() == false)
            {
                Log("*Please connect the device first!");
                return -1024;
            }

            if (txtTZIndex.Text.Trim() == "")
            {
                Log("*Please input TimeZoneIndex first!");
                return -1023;
            }
            ...
            else
            {
                ...
                {
                    Log("*Operation failed,ErrorCode=" + idwErrorCode.ToString() + ",Over TimeZoneIndex limits!");
                }
                else
                {
                    Log("*Operation failed,ErrorCode=" + idwErrorCode.ToString());
        ...
        public int sta_SetTZInfo(TextBox txtTZIndex, DateTimePicker dtSUNs, DateTimePicker dtMONs, DateTimePicker dtTUEs, DateTimePicker dtWENs, DateTimePicker dtTHUs, DateTimePicker dtFRIs, DateTimePicker dtSATs, DateTimePicker dtSUNe, DateTimePicker dtMONe, DateTimePicker dtTUEe, DateTimePicker dtWENe, DateTimePicker dtTHUe, DateTimePicker dtFRIe, DateTimePicker dtSATe)
        {
            if (GetConnectState() == false)
            {
                Log("*Please connect the device first!");
            ...
            if (axCZKEM1.SetTZInfo(iMachineNumber, iTimeZoneID, sTimeZone))
            {
                ...
                axCZKEM1.RefreshData(iMachineNumber);
                Log("Successfully set the TimeZone" + iTimeZoneID + "！");
            }
            else
            {
                axCZKEM1.GetLastError(ref idwErrorCode);
                ...
                {
                    Log("*Operation failed,ErrorCode=" + idwErrorCode.ToString() + ",TimeZone Format Error!");
                }
                else
                {
                    Log("*Operation failed,ErrorCode=" + idwErrorCode.ToString());
        ...
        public int sta_GetGroupTZ(TextBox txtACGroupNo, TextBox txtTZIndex1, TextBox txtTZIndex2, TextBox txtTZIndex3, ComboBox cboACValidHoliday, ComboBox cbVerifyStyle)
        {
            if (GetConnectState() == false)
            {
                Log("*Please connect the device first!");
        ...
        public int sta_SetGroupTZ(TextBox txtACGroupNo, TextBox txtTZIndex1, TextBox txtTZIndex2, TextBox txtTZIndex3, ComboBox cboACValidHoliday, ComboBox cbVerifyStyle)
        {
            if (GetConnectState() == false)
            {
                Log("*Please connect the device first!");
            ...
            {
                axCZKEM1.RefreshData(iMachineNumber);//the data in the device should be refreshed
                Log("Set GroupTZ, GroupNo:" + iGroupNo.ToString() + " VerifyStyle:" + iVerifyStyle.ToString());
            }
            else
            {
                axCZKEM1.GetLastError(ref idwErrorCode);
        ...
        #region UnlockGroup
        public int sta_GetUnLockGroup(ComboBox cboACComNo, ComboBox cboGroup1, ComboBox cboGroup2, ComboBox cboGroup3, ComboBox cboGroup4, ComboBox cboGroup5)
        {
            if (GetConnectState() == false)
            {
                Log("*Please connect the device first!");
            ...
            if (axCZKEM1.SSR_GetUnLockGroup(iMachineNumber, iComNo, ref iGroup1, ref iGroup2, ref iGroup3, ref iGroup4, ref iGroup5))
            {
                ...
                Log("Get unlock group successfully");
            }
            else
            {
                axCZKEM1.GetLastError(ref idwErrorCode);
        ...
        public int sta_SetUnLockGroup(ComboBox cboACComNo, ComboBox cboGroup1, ComboBox cboGroup2, ComboBox cboGroup3, ComboBox cboGroup4, ComboBox cboGroup5)
        {
            if (GetConnectState() == false)
            {
                Log("*Please connect the device first!");
            ...
            {
                Log("*Please input the five groups first!");
                return -1023;
            }
            int idwErrorCode = 0;
            ...
            {
                axCZKEM1.RefreshData(iMachineNumber);//the data in the device should be refreshed
                Log("SetUnlockGroups, Groups:" + iGroup1.ToString() + ":" + iGroup2.ToString() + ":" + iGroup3.ToString() + ":" + iGroup4.ToString() + ":" + iGroup5.ToString());
            }
            else
            {
                axCZKEM1.GetLastError(ref idwErrorCode);
                if (idwErrorCode == -2001)
                    Log("*Operation failed,ErrorCode=" + idwErrorCode.ToString()+". Group Not Exist");
                else
                    Log("*Operation failed,ErrorCode=" + idwErrorCode.ToString());
                return idwErrorCode;
            }
        ...
        #region UserGroup
        public int sta_GetUserGroup(ComboBox cboUAUserIDGroup, TextBox txtGroupNo1)
        {
            if (GetConnectState() == false)
            {
                Log("*Please connect the device first!");
            ...
            if (axCZKEM1.GetUserGroup(iMachineNumber, iUserID, ref iUserGrp))
            {
                ...
                Log("Get user group successfully");
            }
            else
            {
                axCZKEM1.GetLastError(ref idwErrorCode);
        ...
        public int sta_SetUserGroup(ComboBox cboUAUserIDGroup, TextBox txtGroupNo1)
        {
            if (GetConnectState() == false)
            {
                Log("*Please connect the device first!");
            ...
            {
                axCZKEM1.RefreshData(iMachineNumber);//the data in the device should be refreshed
                Log("Set User Group, UserID:" + iUserID.ToString() + ", Group No:" + iUserGrp.ToString());
            }
            else
            {
                axCZKEM1.GetLastError(ref idwErrorCode);
        ...
        #region UserTimeZone
        public int sta_GetUserTZStr(ComboBox cboUAUserIDTZ, ComboBox cbUserTZtype, TextBox txtUTZIndex1, TextBox txtUTZIndex2, TextBox txtUTZIndex3)
        {
            if (GetConnectState() == false)
            {
                Log("*Please connect the device first!");
            ...
            Log(iTZs[0].ToString() + iTZs[1].ToString() + iTZs[2].ToString() + iTZs[3].ToString());
            */
        ...
        public int sta_SetUserTZStr(ComboBox cboUAUserIDTZ, ComboBox cbUserTZtype, TextBox txtUTZIndex1, TextBox txtUTZIndex2, TextBox txtUTZIndex3)
        {
            if (GetConnectState() == false)
            {
                Log("*Please connect the device first!");
        ...
        public int sta_UseGroupTimeZone(ComboBox cboUAUserIDTZ, Label lbUserTimezoneType)
        {
            if (GetConnectState() == false)
            {
                Log("*Please connect the device first!");
            ...
            if (cboUAUserIDTZ.Text.Trim() == "")
            {
                Log("*Please input the UserID first!");
                return -1023;
            }
            int idwErrorCode = 0;
            ...
            if (axCZKEM1.GetUserTZStr(iMachineNumber, iUserID, ref sTZs))
            {
                if (axCZKEM1.UseGroupTimeZone())
                {
                    ...
                    Log("Using Group TimeZone");
                }
                else
                {
                    lbUserTimezoneType.Text = "Not Using Group TimeZone";
                    Log("Not Using Group TimeZone");
                }
            }
            else
            {
        ...
        public int sta_ACUnlock(TextBox txtDelay)
        {
            if (GetConnectState() == false)
            {
                Log("*Please connect the device first!");
            ...
            if (axCZKEM1.ACUnlock(iMachineNumber, iDelay))
            {
                ...
                Log("ACUnlock, Dalay Seconds:" + iDelay.ToString());
            }
            else
            {
                axCZKEM1.GetLastError(ref idwErrorCode);
        ...
        public int sta_CloseAlarm(ListBox lblOutputInfo)
        {
             ...
             * */
            Log("[func CloseAlarm]Temporarily unsupported");
            return 1;
        }
        #endregion

        #region get and set wiegandfmt
        public int sta_GetWiegandFmt(TextBox txtShowWiegandFmt)
        {
            if (GetConnectState() == false)
            {
                Log("*Please connect the device first!");
        ...
        public int sta_SetWiegandFmt(TextBox txtSetWiegandFmt)
        {
            if (GetConnectState() == false)
            {
                Log("*Please connect the device first!");
        ...
        #region Holiday
        public int sta_SetHoliday(TextBox txtHolidayId, DateTimePicker dtStartDate, DateTimePicker dtEndDate, TextBox txtTimeZoneId)
        {
            if (GetConnectState() == false)
            {
                Log("*Please connect the device first!");
        ...
        public int sta_GetHoliday(TextBox txtHolidayId, DateTimePicker dtStartDate, DateTimePicker dtEndDate, TextBox txtTimeZoneId)
        {
            if (GetConnectState() == false)
            {
                Log("*Please connect the device first!");
        ...
        public int sta_SetNONCTimeZone(int parName, TextBox parm)
        {
            if (GetConnectState() == false)
            {
                Log("*Please connect the device first!");
            ...
            if (Convert.ToInt32(par) != 0)
            {
                ...
                {
                    Log("*The NO and NC can not be same!");
                    return -1021;
                }
            }
            if (parName == 81)
        ...
        public int sta_GetNONCTimeZone(int parName, TextBox parm)
        {
            if (GetConnectState() == false)
            {
                Log("*Please connect the device first!");
        ...
        public int sta_SYNCTime(Label lbDeviceTime)
        {
            if (GetConnectState() == false)
            {
                Log("*Please connect first!");
            ...
            {
                axCZKEM1.RefreshData(iMachineNumber);//the data in the device should be refreshed
                Log("Successfully SYNC the PC's time to device!");
            }
            else
            {
                axCZKEM1.GetLastError(ref idwErrorCode);
        ...
        public int sta_GetDeviceTime(Label lbDeviceTime)
        {
            if (GetConnectState() == false)
            {
                Log("*Please connect first!");
            ...
            if (axCZKEM1.GetDeviceTime(iMachineNumber, ref idwYear, ref idwMonth, ref idwDay, ref idwHour, ref idwMinute, ref idwSecond))//show the time
            {
                ...
                Log("Get devie time successfully");
            }
            else
            {
                axCZKEM1.GetLastError(ref idwErrorCode);
        ...
        public int sta_SetDeviceTime(DateTimePicker dtDeviceTime)
        {
            if (GetConnectState() == false)
            {
                Log("*Please connect first!");
            ...
            DateTime date = dtDeviceTime.Value;
        ...
        public int sta_btnPlayWavByIndex(ComboBox cbWavIndex)
        {
            if (GetConnectState() == false)
            {
                Log("*Please connect first!");
            ...
            {
                Log("Position(Wav Index) cannot be null!");
                return -1023;
            }
            ...
            {
                Log("PlayWavByIndex " + iIndex.ToString());
            }
            else
            {
                axCZKEM1.GetLastError(ref idwErrorCode);
        ...
        #region update
        public int sta_btnUpdateFirmware(TextBox txtFirmwareFile)
        {
            if (GetConnectState() == false)
            {
                Log("*Please connect first!");
            ...
            {
                Log("UpdateFirmware,Name=" + sFirmwareFile);
            }
            else
            {
                axCZKEM1.GetLastError(ref idwErrorCode);
        ...
        public int sta_btnSendFile(TextBox txtSendFileName)
        {
            if (GetConnectState() == false)
            {
                Log("*Please connect first!");
            ...
            {
                Log("*Please input the FileName  first!");
                return -1023;
            }
            ...
            {
                axCZKEM1.RefreshData(iMachineNumber);//the data in the device should be refreshed
                Log("SendFile " + sFileName + " To the Device! ");
            }
            else
            {
                axCZKEM1.GetLastError(ref idwErrorCode);
        ...
        public int sta_btnReadFile(TextBox txtReadFileName, TextBox txtFilePath)
        {
            if (GetConnectState() == false)
            {
                Log("*Please connect first!");
            ...
            {
                Log("*Please input the FileName and FilePath first!");
                return -1023;
            }
            ...
            {
                Log("ReadFile " + sFileName + " To " + sFilePath);
            }
            else
            {
                axCZKEM1.GetLastError(ref idwErrorCode);
